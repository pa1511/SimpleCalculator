...
public class BitOr extends BinomialSyntaxNode{

	public BitOr(ILexicalUnit unit) {
		super(unit);
	}
	...
	protected void differentOperatorSizesAndBothNotOne(List<Double> results) {
		throw new IllegalArgumentException("Bit or cannot be done between vectors of different size");
	}
	...
	private void checkArgument(Double value) {
		if(!((value == Math.floor(value)) && !Double.isInfinite(value)))
			throw new IllegalArgumentException("Bit operation Or not definied on non integer values.");
	}
